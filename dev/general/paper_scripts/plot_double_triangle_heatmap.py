...
class main:
    ...
    def create_argument_parser():
        ...
        parser.add_argument(
            "-d1", "--data1", type=str, required=True, help="The path to first file."
        )
        parser.add_argument(
            "-data1_transpose",
            action="store_true",
        ...
        parser.add_argument(
            "-d2", "--data2", type=str, required=True, help="The path to second file."
        )
        parser.add_argument(
            "-data2_transpose",
            action="store_true",
    ...
    def start(self):
        ...
        self.plot_heatmap(df=corr_df, xlabel=self.data1_name, ylabel=self.data2_name)
    ...
    def print_arguments(self):
        ...
        print(
            "  >     (1) {}: {} {}".format(
                self.data1_name, self.data1_path, "[T]" if self.data1_transpose else ""
            )
        )
        print(
            "  >     (2) {}: {} {}".format(
                self.data1_name, self.data1_path, "[T]" if self.data2_transpose else ""
            )
        )

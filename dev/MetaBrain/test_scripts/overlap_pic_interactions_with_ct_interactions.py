...
class main:
    def __init__(self):
        ...
        self.decon_eqtl_interactions_path = getattr(
            arguments, "decon_eqtl_interactions"
        )
    ...
    def create_argument_parser():
        ...
        parser.add_argument(
            "-pi", "--pic_interactions", type=str, required=True, help=""
        )
        parser.add_argument(
            "-di", "--decon_eqtl_interactions", type=str, required=True, help="T"
        )
        parser.add_argument(
            "-o",
            "--outfile",
    ...
    def start(self):
        ...
        decon_eqtl_df = self.load_file(
            self.decon_eqtl_interactions_path, header=0, index_col=0
        )
        print(decon_eqtl_df)
        ...
        for i in range(1, 50):
            fpath = os.path.join(
                self.pic_interactions_path, "PIC_interactions", "PIC{}.txt.gz".format(i)
            )
        ...
        print("Comparing")
        df1_df2_replication_df = self.create_replication_df(
            df1=pic_df, df2=decon_eqtl_df
        )
        self.plot_heatmap(
    ...
    def print_arguments(self):
        ...
        print(
            "  > Decon-eQTL interactions path: {}".format(
                self.decon_eqtl_interactions_path
            )
        )
